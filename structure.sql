...
--
-- Host: 170.64.209.195    Database: bubbletea_db
-- ------------------------------------------------------
...
CREATE TABLE `order_items` (
  ...
  CONSTRAINT `order_items_ibfk_2` FOREIGN KEY (`flavor_id`) REFERENCES `flavors` (`id`) ON DELETE CASCADE
...
CREATE TABLE `orders` (
  ...
  `payment_method` enum('Cash','Bank Transfer','Points','EFTPOS') NOT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT NULL,
  `updated_by` varchar(100) DEFAULT NULL,
  `order_code` varchar(10) DEFAULT NULL,
  `order_status` enum('Pending Payment','Payment Verification','Points Verification','Paid','Cancelled') NOT NULL DEFAULT 'Pending Payment',
...
-- Dump completed on 2026-04-06  0:51:13
